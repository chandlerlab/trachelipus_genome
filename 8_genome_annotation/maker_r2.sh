#!/bin/bash
#PBS -k o 
#PBS -l nodes=8:ppn=8,vmem=250gb,walltime=96:00:00
...
############ Second round with trained SNAP and Augustus models
...
sed 's/^snaphmm= #/snaphmm=\/N\/dc2\/scratch\/chrichan\/trachelipus_assembly\/maker_r1\/snap1\/trachelipus_v1.zff.length50_aed0.25.hmm #/' TEMP2 > TEMP1
