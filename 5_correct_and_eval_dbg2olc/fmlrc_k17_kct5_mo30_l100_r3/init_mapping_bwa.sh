#!/bin/bash
#PBS -k o 
#PBS -l nodes=1:ppn=24,vmem=500gb,walltime=12:00:00
...
UNCORRECTED=/N/dc2/scratch/chrichan/trachelipus_assembly/all_dbg2olc/pilon/${ASSEMBLY}_r2/corrected.fasta
